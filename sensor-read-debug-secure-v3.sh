#!/usr/bin/env bash
# sensor-read-debug-secure-v3.sh — Coral Env Sensor Board readout
#
# Changes from sensor-read-debug-secure-v2.sh:
...
#
# Usage:
#   chmod +x sensor-read-debug-secure-v3.sh
#   ./sensor-read-debug-secure-v3.sh                 # hello -> sensors -> bye
#   ./sensor-read-debug-secure-v3.sh --loop          # hello -> forever -> (Ctrl-C) -> bye
#   ./sensor-read-debug-secure-v3.sh --cycle 5       # 5s per reading
#   ./sensor-read-debug-secure-v3.sh --test-pattern  # hello + bye only
#   SPI_LOCK_WAIT=15 ./sensor-read-debug-secure-v3.sh  # wait up to 15s for the bus
...
echo "${C_DIM}══════════════════════════════════════════${C_RST}"
echo "${C_HDR}Coral Env Sensor — secure v3${C_RST}"
